	...
	var DatatableDataLocalDemo=function(){var e=function(){
		...
		var e= data,
			...
			columns:[
				...
				{field:"position_id",title:"Position",template:function(e){var a={1:{title:"Leader",state:"primary"},2:{title:"Pengerja",state:"info"},3:{title:"Jemaat",state:"danger"}};return'<span class="m-badge m-badge--'+a[e.position_id].state+' m-badge--dot"></span>&nbsp;<span class="m--font-bold m--font-'+a[e.position_id].state+'">'+a[e.position_id].title+"</span>"}},
	...
	var DatatableHtmlTableDemo=function(){var e=function(){
		var e= data,
			...
			columns:[
				...
				{field:"user_phone",title:"Phone"},
				{field:"user_kaj",title:"No. KAJ"},
				{field:"event_name",title:"Event"},
				{field:"event_date",title:"Event Date"},
				{field:"attend_date",title:"Attend Date"}
